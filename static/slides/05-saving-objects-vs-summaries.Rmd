...
penguins_f_table <- penguins_f_table %>% 
  arrange(n)
...
- Save a ggplot as an object if you want to "call it" later to add more layers, or if you want to save it
- `ggsave()` by default saves the last plot printed, but to be extra careful you can use the object name
...
Now we can add additional layers, and/or save it!
