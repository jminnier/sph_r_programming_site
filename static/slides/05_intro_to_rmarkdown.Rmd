...
- knitting: generating outputs from codeblocks
- Output + markdown is then passed down to a "rendering engine"
...
# Let's learn about Front Matter
...
```
{r setup}
#this chunk is always run, even if you hit play on a later chunk
```
...
.pull-right[
- Don't have to just be R! Can be `python` as well
