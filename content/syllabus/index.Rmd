...
Part 1 (Intro to R/RStudio, Functions, Vectors, Data Types)
Part 2 (Loading Data (xls/haven)), data.frames, and ggplot2
Part 3 ggplot2, factors, boxplots, dplyr part 1, more flipbook stuff!
Part 4. dplyr: mutate, group_by/summarize
Part 5. More about manipulating factors and dates/doing things with multiple tables/conditionals
Part 6. Functions/For loops/batch processing/purrr
Part 7. Stats/formulas/broom
Part 8. Tidymodels/machine learning basics/simulation (infer?/permutation)
Part 9. Intro to Bioconductor
Part 10. Wrap/up (shiny/interactive graphics) shiny, leaflet, plotly, tidytext

## Course Website

All course information will be available here:

https://sphr.netlify.com/

Course discussions will be done in the class Slack Workspace. Invites will be sent before class.

https://sphr.slack.com
...
- In class discussion/short function presentation 15%
- Midterm 20%
