...
8. **Create** fancy tables in our R markdown reports with `gt`.
9. **Learn** about Bioconductor Data Structures and conduct simple analysis with these structures.
10. **Execute** basic machine learning workflows using `tidymodels`.
11. **Build** basic interactive applications with `shiny`.
