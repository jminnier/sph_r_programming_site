...
p_boxplot <- ggplot(mtcars, aes(x=cyl, y=disp)) + geom_point()
...
ggsave(plot = p_boxplot, filename = "myboxlot.png")
```
...
Let's break this down in parts, starting with just vectors, not a data.frame:
...
class(myvec)
# Now let's run that first code "test" which is a boolean statement
myvec == "alive"
