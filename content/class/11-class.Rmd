...
Yeah, survival is hard and you really need a real stats course on it first, and then seeing the code will make more sense! It's why we (and most biostats programs) have a full course called Survival Analysis!

> Debugging

Understandable, I had to go through that very quickly! You can read more debugging in the [Advanced R Debugging chapter](https://adv-r.hadley.nz/debugging.html).
