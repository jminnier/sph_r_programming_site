...
linktitle: "1: Introduction to R/RStudio/Vectors/"
date: "2021-01-07"
...
- `r knitr::include_url("https://www.youtube.com/watch?v=uK1Va_UWQFc")` 
- [R and RStudio Basics](https://ismayc.github.io/rbasics-book/3-rstudiobasics.html) - make sure to watch the videos.
- [https://ubc-dsci.github.io/introduction-to-datascience/wrangling.html#vectors-and-data-frames](Vectors and Data Frames)

## Optional 

### Markdown Basics

This is a short reference on how to do formatting in Markdown. This is optional, but may be a helpful reference as you continue on.

https://sph-r-programming/reference/markdown.html
